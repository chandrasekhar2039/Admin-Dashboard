...
useEffect(()=>{
  var getdata= async()=>{
    try{
      var list = await API.get("category_list");
    ...
    <>
      ...
      <>
        <div className="p-2 m-2 row">
          <h1>No Category image </h1>
          <p>Add category to see categories Image</p>
        </div>
        <div className="p-2 m-2 row">
